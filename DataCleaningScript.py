...
def cleanData():
    ...
    master = maindata.join(studentdata, on = 'UserId', lsuffix = '', rsuffix = '_student', how = 'inner')

    # joins answer data to master data
    master = master.join(answerdata, on = 'AnswerId', lsuffix = '', rsuffix = '_answer', how = 'inner')

    # joins question data - with out updated changes from above - to master data
    master = master.join(questiondata, on = 'QuestionId', lsuffix = '', rsuffix = '_question', how = 'inner')
